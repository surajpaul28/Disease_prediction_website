...
<div class="flex-p-2">
<li><button type="submit" name="submit" >Naive bayes</button></li> 
<li><button type="submit" name="submit" >KNN</button></li>
<li><button type="submit" name="submit" >K-means</button></li>
<li><button type="submit" name="submit" >Random Forest</button></li>
<li><button type="submit" name="submit" >Decission Tree</button></li>
</div>
</div>
